...
const Home = () => {
    ...
    const API = "https://razorpayserver-e7gy.onrender.com/api/checkout";
    const API_KEY = "https://razorpayserver-e7gy.onrender.com/api/apiKey";
    ...
    order_id: order.id, 
    callback_url: "https://razorpayserver-e7gy.onrender.com/api/paymentVerification",
    prefill: {
        "name": "Demo User",
